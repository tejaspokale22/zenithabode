...
const ProductCard = ({ product }) => (
  <div className="p-4 text-left rounded-2xl bg-gray-50/70 group sm:p-6">
    <div className="relative mb-4">
      <div className="absolute top-3 left-3 z-10 px-3 py-1 text-xs font-semibold text-white bg-green-700 rounded-full">
        {product.discount}
      </div>
      ...
      <div className="container px-4 mx-auto max-w-7xl text-center">
        <div className="mb-12">
          ...
          <h2 className="text-3xl font-bold text-gray-800 sm:text-4xl lg:text-5xl">
            Our Products <span className="text-green-700">Collections</span>
          </h2>
        </div>
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-8 md:gap-4 md:mb-12">
          {categories.map((category) => (
            <button
              ...
              className={`px-4 py-2 text-sm rounded-full font-semibold transition-colors md:px-6 md:py-3 md:text-base ${
