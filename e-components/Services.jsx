        ...
        <div className="grid grid-cols-1 gap-8 text-center sm:grid-cols-3">
          ...
          <div className="flex justify-center items-center">
            <div className="flex items-center space-x-3">
                ...
                <div>
                    <p className="text-lg font-bold text-left text-gray-900">24x7 Support</p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-16 lg:grid-cols-3">
            ...
            <div className="flex flex-col p-6 rounded-2xl bg-gray-50/70 lg:col-span-2 md:flex-row md:p-8">
                <div className='space-y-4 md:w-1/2'>
                    ...
                    <h2 className="text-3xl font-bold text-gray-900">Chairs</h2>
                ...
                <div className='flex justify-center items-center mt-8 md:w-1/2 md:mt-0'>
                    <Image src={assets.chair} alt="Chair" width={400} height={500} className="max-h-[300px] object-contain rounded-2xl md:max-h-[400px]"/>
                </div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col items-center p-4 rounded-2xl bg-gray-50/70 sm:flex-row sm:p-6">
                   ...
                   <div className='mt-4 sm:w-1/2 sm:mt-0'>
                         <Image src={assets.sofa} alt="Sofa" width={250} height={250} className="object-contain w-full rounded-2xl"/>
                   </div>
                </div>
                ...
                <div className="flex flex-col items-center p-4 rounded-2xl bg-gray-50/70 sm:flex-row sm:p-6">
                    ...
                    <div className='mt-4 sm:w-1/2 sm:mt-0'>
                        <Image src={assets.lamp} alt="Lighting" width={200} height={150} className="object-contain w-full rounded-2xl"/>
                    </div>
                </div>
            </div>
        </div>
