...
const EProjects = () => {
  ...
  const projectsData = [
    ...
    },
    {
      ...
      number: "05",
      title: "Outdoor Patio Furnishing",
    },
    {
    ...
    <section className="py-16 bg-white sm:py-20">
      <div className="container px-4 mx-auto">
        <div className="flex flex-col justify-between mx-auto mb-10 max-w-6xl md:flex-row md:items-center">
          <div className="md:w-2/3">
            ...
            <h2 className="text-3xl font-bold text-gray-800 sm:text-4xl">
              Explore Our Recent{" "}
              <span className="text-green-700">Interior Design</span> Projects
            </h2>
          </div>
          <p className="mt-4 text-gray-500 md:w-1/3 md:mt-0 md:pl-8">
            Discover a collection of our finest work, showcasing unique designs
            and beautiful craftsmanship that bring our clients&apos; visions to
            life.
          </p>
        </div>
        ...
        >
              ...
              <SwiperSlide key={project.number} className="group/slide">
                <div className="relative h-[450px] w-full overflow-hidden rounded-lg">
                  ...
                  <div className="flex absolute inset-0 flex-col justify-end p-6 text-white">
                    <p className="mb-2 text-5xl font-thin text-white text-opacity-60">
                      {project.number}
                    </p>
          ...
          <div
            className={`absolute left-4 top-1/2 z-10 p-3 rounded-full shadow-lg -translate-y-1/2 cursor-pointer swiper-button-prev-custom bg-white/90 backdrop-blur-sm transition-opacity duration-300 hover:bg-white ${
          ...
          <div
            className={`absolute right-4 top-1/2 z-10 p-3 rounded-full shadow-lg -translate-y-1/2 cursor-pointer swiper-button-next-custom bg-white/90 backdrop-blur-sm transition-opacity duration-300 hover:bg-white ${
              isHovered ? "opacity-100" : "opacity-0"
            }`}
          >
    ...
    <section className="bg-[#f8f9fa] py-16 sm:py-20">
      <div className="container px-4 mx-auto">
        <div className="mb-12 text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-800 sm:text-4xl">
            Meet Our <span className="text-green-700">Expert Team</span>
          </h2>
        </div>
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="p-6 text-center bg-white rounded-lg shadow-sm transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group"
            >
...
const EBlog = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      date: "May 28, 2024",
      title: "How to Create a Stunning Accent Wall",
      link: "/blog/post-2",
    },
    {
      ...
      category: "Smart Home",
      date: "May 31, 2024",
      title: "Integrating Technology for a Seamless Living Experience",
      link: "/blog/post-3",
    },
  ];
      ...
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post, index) => (
            <div
              key={index}
              className="overflow-hidden bg-white rounded-lg shadow-sm transition-shadow duration-300 group hover:shadow-xl"
            >
              ...
              <div className="p-6">
                <div className="flex items-center mb-3 text-xs text-gray-500">
                  <span className="font-semibold tracking-wider text-green-700 uppercase">
                    {post.category}
                  </span>
