...
export default function CatalogueSection() {
    ...
    return (
        <div className="grid gap-8 divide-gray-300 lg:divide-x lg:gap-0 lg:grid-cols-4 md:grid-cols-2">
            {items.map((item) => (
                <div key={item.id} className="overflow-hidden relative group">
                    <div>
                    ...
                    <div className="hidden inset-0 flex-col gap-32 justify-end items-center pb-16 text-xl border-b-2 transition duration-300 ease-in-out md:flex md:absolute group-hover:translate-y-full md:border-b-0 bg-zinc-100">
