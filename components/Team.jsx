          ...
          <div className="px-2 pt-10 mb-8 w-full xs:px-4 xs:pt-16 sm:pt-20 xs:mb-12 lg:w-5/12 lg:mb-0">
            <div className="max-w-md">
              <div className="relative">
                <h2 className="absolute -top-12 xs:-top-16 left-0 text-gray-200 text-5xl xs:text-7xl sm:text-8xl md:text-[100px] font-semibold opacity-40 tracking-widest">
                  TEAM
                </h2>
                <h3 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-[#292f36] z-10">
                  Our Awesome Team Members
                </h3>
              </div>
              <p className="mb-6 text-sm text-gray-500 xs:mb-8 xs:text-base">
                To explore and go after new ways to build, we&apos;ve gathered
                the people, innovations, & partnerships that can anticipate &
                overcome new challenges.
              </p>
              <div className="flex items-center">
                <span className="text-3xl xs:text-4xl sm:text-5xl font-bold text-[#292f36] mr-3 xs:mr-4">
                  4.20
                </span>
                <div>
                  ...
                  <span className="text-xs font-bold text-gray-500 xs:text-sm sm:text-base">
                    2,500 Rating
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-6 xs:space-y-8">
                {teamMembers
                  ...
                  .map((member) => (
                    <div
                      key={member.name}
                      className="bg-white rounded-3xl shadow-lg group"
                    >
                      <div className="relative">
                        <Image
                          src={member.image}
                          ...
                          width={300}
                          height={400}
                          className="w-full h-[220px] xs:h-[260px] sm:h-[320px] md:h-[380px] lg:h-[400px] rounded-2xl object-cover"
                        />
                      ...
                      <div className="p-3 text-center xs:p-4">
                        <h4 className="text-base xs:text-lg sm:text-xl md:text-2xl font-bold text-[#292f36]">
                          {member.name}
                        </h4>
                        <p className="text-xs text-gray-500 xs:text-sm sm:text-base">
                          {member.role}
                        </p>
                      </div>
                    </div>
